...
| جدول ۴-۴ | آزمون شبکهٔ واژگان WordNet | ۴-۴-۳ |
| جدول ۴-۵ | ablation سهم اجزا (پیکرهٔ QA-sample) | ۴-۵-۲ |
| جدول ۴-۶ | سایر یافته‌های پارامتری | ۴-۵-۳ |
| جدول ۴-۷ | مقایسهٔ ادبی با مدل‌های تعبیه کلمات | ۴-۷-۲ |
| جدول ۴-۸ | خط مبنای تراکمی MiniLM روی SciFact | ۴-۷-۱ |
...
### ۴-۷-۱. خط مبنای تراکمی اجراشده روی SciFact

برای آنکه مقایسه با شبکه‌های عصبی فراتر از ارجاع ادبی باشد، یک مدل بازیابی تراکمی واقعی (`all-MiniLM-L6-v2`، 384بعدی، شباهت کسینوسی روی همان ۲۱۳ سند و ۲۰۰ پرسش) اجرا شد:
