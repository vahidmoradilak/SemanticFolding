...
from lib import detect_language
    ...
    with open(corpus_path, 'r', encoding='utf-8') as f:
        for i, line in tqdm(enumerate(f)):
            ...
            try:
                ...
                text_original = normalizer.normalize(text_original) # delete arab arabic
                text_lower = text_original.lower()
                ######
                # if detect_language(text_original) == "en":
                #     text_lower = text_original.lower()
                # else:
                #     text_lower = normalizer.normalize(text_original)
            except ValueError:
